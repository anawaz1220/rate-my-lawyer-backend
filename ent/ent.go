...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			lawyer.Table:             lawyer.ValidColumn,
			lawyerjurisdiction.Table: lawyerjurisdiction.ValidColumn,
			mvpmaterial.Table:        mvpmaterial.ValidColumn,
			mvpplannedroute.Table:    mvpplannedroute.ValidColumn,
			mvproute.Table:           mvproute.ValidColumn,
			mvpstaff.Table:           mvpstaff.ValidColumn,
			mvptruck.Table:           mvptruck.ValidColumn,
			passwordtoken.Table:      passwordtoken.ValidColumn,
			rmluser.Table:            rmluser.ValidColumn,
